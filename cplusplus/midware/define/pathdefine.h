...
#define TRANSLATION_PATH        APP_DIR_PTH + CONTACT_STR_3(/, TRANSLATION_RELATIVE_PATH, /)
#define TRANSLATION_PATH_ZH     TRANSLATION_PATH + CONTACT_STR_2(ZH_NAME, .qm)
#define TRANSLATION_PATH_EN     TRANSLATION_PATH + CONTACT_STR_2(EN_NAME, .qm)
...
#define APP_ICON_PATH           APP_DIR_PTH + CONTACT_STR_2(/, IMAGE_RELATIVE_PATH, /)
